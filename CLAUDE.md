...
| 2026-06-05 | 일곱 번째 책 추가: 『연우의 그림 전시회』 (27p, 갤러리 형식). 연우의 작품 사진 25장(종이접기·그리기)을 **자동 크롭**(배경=어두운 바닥+핑크 바인더 제외, HSV 마스크 행/열 프로파일 bbox)으로 일괄 보정 후 작품마다 짧은 스토리 캡션. 자동크롭 스크립트 ywoo/Horizontal/autocrop.py, 빌드 _workspace/07_build_bookjson.py. 원본 사진(ywoo/Horizontal/, 84MB)은 용량상 미커밋 | books/07-yeonwoo-art-gallery/ | 아이 작품 25점 갤러리북 |
| 2026-06-05 | **책06을 책07에 병합**: 『연우가 그린 그림나라』(놀이동산·캠핑 2작품)를 전시회 scene 26·27로 편입 → 책07 29p. 책06 디렉토리 삭제, 라이브러리에서 제거 | books/07-yeonwoo-art-gallery/, books/06-* 삭제 | 책 통합 요청 |
